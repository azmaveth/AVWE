...
public:
  ...
  A(string a) : s(new string(a)) {
    ++this->refcount;
    cout << "+++++ Constructor invoked. " << *this->s << " at: " << this
         << endl;
  }
  ...
  A &operator=(const A &a) {
    ...
    cout << "Copy assignment operator invoked. " << *this->s << " at: " << this
         << endl;
    return *this;
  };
  ...
  A &operator=(A &&a) {
    ...
    cout << "Move assignment operator invoked. " << *this->s << " at: " << this
         << endl;
    return *this;
  }
  ...
  ~A() {
    --this->refcount;
    cout << "----- Destructor invoked. refcount:" << this->refcount
         << " at: " << this << endl;
    if (this->refcount <= 0) {
      delete this->s;
      cout << "~~~~~ deleted. "
